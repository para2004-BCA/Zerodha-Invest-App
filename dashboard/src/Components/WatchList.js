...
const WatchlistActions = ({ uid }) => {
  const { openBuyWindow } = useContext(GeneralContext); // ✅ Correct use of context

  const handleBuyClick = () => {
    console.log("Opening Buy popup for:", uid); // ✅ Optional debug
    openBuyWindow(uid); // ✅ Trigger the popup
  };
